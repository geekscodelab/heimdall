...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Heimdall',
    'DESCRIPTION': 'Authentication & Authorization Service API Doc',
    'VERSION': '0.1.0',
    'SERVE_INCLUDE_SCHEMA': False,
    # OTHER SETTINGS
    # Without setting `COMPONENT_SPLIT_REQUEST`, FileField file uploads won't work correctly.
    # https://stackoverflow.com/a/67522312
